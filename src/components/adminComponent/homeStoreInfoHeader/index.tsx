...
function AddHomeStoreInfoHeader() {
  return (
    <div className=' '  dir='rtl'>
           <div className=' px-10 mt-2 flex gap-5 flex-wrap-reverse text-xs md:text-lg mb-5'>
        ...
        <Link to={""} className='bg-gray-200 px-2 rounded-2xl ml-5 hover:cursor-pointer hover:bg-gray-300' > افزودن کد معرف/ایجاد کاربر</Link>
    </div>
    </div>
