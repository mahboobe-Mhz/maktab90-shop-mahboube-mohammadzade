...
const OtherBrandProductCard = ({productSelect}:Props) => {
  ...
  const navigateToSinglePage =(event:any)=>{
    navigate(`/otherBrandSingleProductPage`)
  }
  const handleInsertToCart=()=>{
    ...
    return (<div className="  md:w-[240px] w-[150px] "   >
...
export default OtherBrandProductCard;