...
import SearchIcon2 from "../../svg/serchIcon2";
const MainHeader = () => {
 ...
 <div className="border-b shadow-md border-[#3f3f3f]">
     <div className="grid grid-cols-2 md:grid-cols-3 direction md:pt-2 mx-auto max-w-[1440px] ">
          <div className="hidden md:flex flex-wrap md:pr-10  gap-1 relative">
           ...
           <span className="mt-3">.</span>
           <img src="/public\logo\b2-01.png" className="relative w-[100px] h-[25px] mt-3 hover:opacity-20 hover:cursor-pointer " onClick={()=>{navigate("/homeStore/فروشگاه ها")}}  alt="" />
          ...
          <div className="flex gap-4 justify-end md:pl-10 pb-1">
            ...
            <div>
            <SearchIcon2 state={state} setState={setState} />
            </div>
