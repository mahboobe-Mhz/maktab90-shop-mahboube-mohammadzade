...
<div className=' bg-white shadow-black shadow-2xl border rounded-2xl  mt-5 pl-1 py-1'>
  <div className='flex flex-col gap-2  overflow-y-scroll  pt-3 pb-3  h-[200px] '>
  {
        products.map(product=>(
            <div key={product._id} id={product._id} data-user={product.slugname} data-category={product.category._id} onClick={handleMoveToSinglePage} className='flex hover:bg-gray-200 hover:cursor-pointer z-40 '>
