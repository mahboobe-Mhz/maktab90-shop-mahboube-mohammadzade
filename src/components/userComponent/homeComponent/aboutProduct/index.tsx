   ...
   const [counter,setCounter]=useState<number>(0)
    return ( <div className="p-14">
        ...
        counter===0 ? <div className="w-[1050px]" >
            ...
            </div> :counter===2 ?  <div className="w-[1050px]">
                <h1 className="text-3xl font-bold pb-3">پارچه ترک مبلی</h1>
            ...
            </div>: counter===3?  <div className="w-[1050px]">
                <h1 className="text-3xl font-bold pb-3">چوب راش</h1>
            ...
            </div>:counter===4 ?  <div className="w-[1050px]">
                <h1 className="text-3xl font-bold pb-3">اسفنج 40 کیلویی</h1>
