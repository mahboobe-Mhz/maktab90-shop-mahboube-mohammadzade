    ...
    <div>
        ...
        <div className='container mx-auto' dir='rtl'>
            <div>
                ...
                <h1 className='text-center text-secondary text-6xl pt-5 pb-10'> اخبار و مقالات</h1>
            </div>
            <div className=' flex flex-col'>
                <div className=' flex gap-3 border-t pt-3  mb-5 border-black px-10' >
                 <img className='w-32 h-32 rounded-3xl border' src="public\picture\میزصندلی.jpg" alt="" />
                 <div className='flex flex-col '>
                    <div className=' grid grid-cols-2 md:grid-cols-3   '>
                        <div className='text-right pt-3'>
                        <h2 className='text-2xl'> اسفنج ۴۰ کیلویی</h2>
                        </div>
                    
                        <div className="flex gap-10  pt-5 text-sm">
            ...
            <button
              className="md:flex hidden text-black border-2 font-semibold pl-2 md:pr-2
