  ...
  return (<div>
    ...
    <div
      ...
      >
        ...
        <div
          className={`transition-all duration-800 border border-black rounded-2xl mt-2 pr-3 pt-3 pb-3 pl-1    
           ${state === "city" ? "flex flex-col" : "hidden"}`}
        >
        ...
        <div className=" border-b flex justify-between border-black mt-1 cursor-pointer">
          <span onClick={() => setState("services")}>
            {" "}
            خدمات پس از فروش
          </span>
          {state === "services" ? (
        ...
        <div className=" border-b flex justify-between border-black mt-1 cursor-pointer">
          <span onClick={() => setState("background")}>
            {" "}
            تعداد سال سابقه
          </span>
          {state === "background" ? (
              ...
              <div>
                ...
                <label className="px-5">
                  <Rating
                    ...
                    value={3}
                    readOnly
                    sx={{ direction: "rtl", marginTop: "5px" , color:"secondary.main"}}
                  />
                  <span className="text-xs pr-1 "> (۵)</span>
                </label>
              </div>
