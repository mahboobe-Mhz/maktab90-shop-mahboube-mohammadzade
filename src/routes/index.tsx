...
const AddCity = React.lazy(
  () => import("../components/adminComponent/addCity")
);
...
export const routes = {
  ADMIN: {
    ...
    colleagueFactor:"/admin/colleagueFactor"
...

  {
    ...
    children: [
      ...
      <IdentificationCode />
        ...
        path: routes.ADMIN.colleagueFactor,
        element:(  
           <SuspenseView>
      <ColleagueFactor />
        </SuspenseView>)
