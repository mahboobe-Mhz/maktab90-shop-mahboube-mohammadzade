...
import OtherBrandProductCard from '../homeStore/otherBrandProductCard';
...
function DailyProducts() {
  ...
  return (
      ...
      <div className=' container mx-auto' dir='rtl'>
          ...
          <div className='flex flex-wrap md:px-16 px-2 justify-center md:gap-12 gap-5  pb-10 mt-10'>
