...
function AddHomeStoreInfo() {
  ...
  const asnaf = [{ label: "لوازم خانگی" }, { label: "فرش" }];

  const city = [{ label: " شیراز" }, { label: "بوشهر" }];
      ...
      <div className="p-5">
        ...
        <div className="flex gap-10 md:flex-row flex-col ">
          <Autocomplete
            ...
            sx={{ width: 200 }}
            renderInput={(params) => (
              <TextField {...params} label="صنف" variant="standard" />
            )}
          />
          ...
          <Autocomplete
            ...
            sx={{ width: 200 }}
            renderInput={(params) => (
              <TextField {...params} label="شهر" variant="standard" />
            )}
          />
        </div>
        ...
        <button className="text-white bg-secondary px-20 py-1.5 rounded-full w-[200px] mx-auto mt-5">
          {" "}
          ثبت
        </button>
        <button className="text-white bg-secondary px-20 py-1.5 rounded-full w-[200px] mx-auto mt-5 mr-2">
          {" "}
          ویرایش
        </button>
      </div>
