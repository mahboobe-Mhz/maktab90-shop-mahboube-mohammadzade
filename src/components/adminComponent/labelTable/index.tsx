...
const ShowTableBox = () => {
   ...
   const allProducts =()=>{
    ...
    <Box sx={{display:"flex", justifyContent:"space-between", bgcolor:"#ffff", alignItems:"center", paddingX:"20px", paddingY:"5px", borderRadius:"20px",marginY:2}}>
                <Typography sx={{color:"secondary.main", fontSize:30}}> برچسب ها</Typography>
                <Button sx={{color:"#ffff", paddingX:"30px", bgcolor:"secondary.main", borderRadius:"50px"}}> افزودن برچسب</Button>
            </Box>
